...
Soni_B5_RelFactor = 1 + Soni_X_B5_PercRelTime * Soni_X_B5_PercRelTime * Soni_B5_MaxRelFactor;
...
Soni_R3_TremoloFX = _ <: *(mult * tremoloLFO),*(1-mult) :> _ with { tremoloLFO = 0.5*(1 + os.osc(tempo/30)); mult = pow(Soni_X_R3_Tremolo,0.6); };
Soni_R4_Dist = _ <: ef.cubicnl(0.8,0)*(mult),*(1-mult) :> _ with { mult = pow(Soni_X_R4_Dist,0.6) * (1 - 0.5*Soni_X_R4_Dist); };
Soni_RZ1_Phaser(oscFreq) = _ : pf.phaser2_mono(Soni_RZ1_numNotches,0,Soni_RZ1_notchWidth,Soni_RZ1_notch1Min,Soni_RZ1_notchSpacing,Soni_RZ1_notch1Max,oscFreq,
											   pow((1 - Soni_X_RZ1_MultiPhaser),2),0,0);
Soni_RZ2_Wah(LFO,minFreq,maxFreq) = _ : fi.peak_eq_cq(currentGain,currentFreq,0.7) : *(ba.db2linear(-0.4*currentGain)) with
{
  ...
  currentGain = 10 * pow((1 - Soni_X_RZ2_MultiWah),2);
};
// // // // // // // // // // // // // // // // // // // // // // // // // // // // // // Generation // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // 
...
S7_Inharmonicity = (os.osc(S7_F) + S7_addedPartials) * 0.4;
